                    ...
                    <tbody>
                        ...
                        @foreach ($solicitudes as $solicitud)
                            <tr>
                                ...
                                <td>
                                @if ($solicitud->estado == 7) <!--Rechazado-->
                                        Rechazado
                                    @elseif ($solicitud->estado == 8) <!--Revision-->
                                        Pendinte
                                    @elseif ($solicitud->estado == 10)<!--Aceptado-->

        ...
        <div class="tabla-contenedor shadow-sm rounded bg-white">
            ...
            <div class="d-flex justify-content-end">
                <div class="button-group mt-3 px-4 mb-4">
                    <button type="button" onclick="return submitForm('pdf')" class="btn btn-success me-2">Generar
                        PDF</button>
                    <button type="button" onclick="return submitForm('excel')" class="btn btn-primary">Generar
                        Excel</button>
                    <button type="button" onclick="return submitForm('delete')" class="btn btn-danger">Eliminar
        ...
        function submitForm(action) {
            ...
            if (action === 'delete') {
                const confirmDelete = confirm(
                    `¿Estás seguro de que deseas eliminar los ${selectedItems.length} proyectos seleccionados?`);
                if (!confirmDelete) {
